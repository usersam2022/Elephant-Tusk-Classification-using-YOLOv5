    ...
    stages {
        ...
        stage('Deploy to EC2') {
            steps {
                ...
                sh 'ssh -o StrictHostKeyChecking=no -i /home/ubuntu/.ssh/tusk_ec2-deployment-key.pem ubuntu@3.109.121.137 "docker pull 820242905325.dkr.ecr.ap-south-1.amazonaws.com/elephant-tusk-classification:latest && docker run -d -p 8080:8080 elephant-tusk-classification:latest"'
            }
        }
    }
}
